...
> {
    ...
    async findOneAndLock<T = EntityDocument>(
        ...
        const repository = this._repository.findOneAndUpdate<T>(find, {
            new: true,
    ...
    async update(
        ...
        return this._repository.findOneAndUpdate(find, data, {
            ...options,
            new: true,
        });
    }
    ...
    async delete(
        ...
        return this._repository.findOneAndDelete(find, {
            ...options,
            new: false,
        });
    }

    async save<T extends EntityDocument>(
        repository: T,
        options?: IDatabaseSaveOptions
    ): Promise<T> {
        return (await repository.save(options)) as T;
    }
    ...
    async updateManyRaw(
        ...
        return this._repository.updateMany(find, data, {
            ...options,
            rawResult: true,
        });
    }
    ...
    async deleteMany(
        ...
        return this._repository.deleteMany(find, {
            ...options,
            rawResult: true,
        });
    }
    ...
    >(
        ...
        const newPipelines: PipelineStage[] = pipelines;
